 ...
 */
export type BambooSaplingStates = Pick<
  BlockStateSuperset,
  "age_bit" | "sapling_type"
>;
/**
 ...
 */
export type CoralBlockStates = Pick<
  BlockStateSuperset,
  "coral_color" | "dead_bit"
>;
/**
 * States specific to CoralFan
 */
export type CoralFanStates = Pick<
  BlockStateSuperset,
  "coral_color" | "coral_fan_direction"
>;
/**
 * States specific to CoralFanDead
 */
export type CoralFanDeadStates = Pick<
  BlockStateSuperset,
  "coral_color" | "coral_fan_direction"
>;
/**
 ...
 */
export type DoublePlantStates = Pick<
  BlockStateSuperset,
  "double_plant_type" | "upper_block_bit"
>;
/**
 ...
 */
export type DoubleWoodenSlabStates = Pick<
  BlockStateSuperset,
  "minecraft:vertical_half" | "wood_type"
>;
/**
 ...
 */
export type LeavesStates = Pick<
  BlockStateSuperset,
  "old_leaf_type" | "persistent_bit" | "update_bit"
>;
/**
 * States specific to Leaves2
 */
export type Leaves2States = Pick<
  BlockStateSuperset,
  "new_leaf_type" | "persistent_bit" | "update_bit"
>;
/**
 ...
 */
export type SaplingStates = Pick<
  BlockStateSuperset,
  "age_bit" | "sapling_type"
>;
/**
 ...
 */
export type StoneBlockSlabStates = Pick<
  BlockStateSuperset,
  "minecraft:vertical_half" | "stone_slab_type"
>;
/**
 ...
 */
export type WoodStates = Pick<
  BlockStateSuperset,
  "pillar_axis" | "stripped_bit" | "wood_type"
>;
/**
 ...
 */
export type WoodenSlabStates = Pick<
  BlockStateSuperset,
  "minecraft:vertical_half" | "wood_type"
>;
/**
...
export type BlockStates =
  ...
  | GrindstoneStates
  | HardStainedGlassStates
  | HardStainedGlassPaneStates
  | HayBlockStates
